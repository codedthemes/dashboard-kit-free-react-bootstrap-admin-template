        ...
        <Col md={12}>
            <Row className="mb-3">
                <Col md={8}>
                    <h3>Typography</h3>
                    <p className="lead">
                        Documentation and examples for Bootstrap typography, including global settings, headings, body text, lists, and
                        more.
                    </p>
                    <p className="f-w-500">
                        Check out{' '}
                        <a
                            href="https://dashboardkit.io/bootstrap/docs/index-bc-package.html#page-typography"
                            rel="noreferrer"
                            target="_blank"
            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <Card.Text className="text-muted mb-4">
                        ...
                        porta augue, consectetur facilisis diam porttitor sed. Suspendisse tempor est sodales augue rutrum tincidunt.
                        Quisque a malesuada purus.
                    </Card.Text>
                    <h3>This is a Heading 3</h3>
                    <Card.Text className="text-muted mb-4">
                        Vestibulum auctor tincidunt semper. Phasellus ut vulputate lacus. Suspendisse ultricies mi eros, sit amet tempor
                        nulla varius sed. Proin nisl nisi, feugiat quis bibendum vitae, dapibus in tellus.
                    </Card.Text>
                    ...
                    <Card.Text className="text-muted mb-4">
                        ...
                        Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio. Vivamus pretium nec
                        odio cursus elementum. Suspendisse molestie ullamcorper ornare.
                    </Card.Text>
